...
Recentemente, houve uma crescente no interesse por visualização tridimensional de estruturas anatômicas.
%
...
%%Conteúdo
O desenvolvimento de nosso simulador, parte do príncipio de reusabilidade e reaproveitamento discutidos anteriormente, usaremos como base o simulador de distribuição "CTScannerSimulator" do Institute for Advanced Clinic Imaging, que por sua vez, é de distribuição privada e tem o intuito de apenas simular as funções básicas de uma máquina física de Resônancia Magnética.
